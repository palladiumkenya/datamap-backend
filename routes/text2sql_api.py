...
jwt_token = 'eyJraWQiOiJHYjM4OWEtOWY3Ni1nZGpzLWE5MmotMDI0MmJrOTQzNTYiLCJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJvcGVuLW1ldGFkYXRhLm9yZyIsInN1YiI6ImluZ2VzdGlvbi1ib3QiLCJlbWFpbCI6ImluZ2VzdGlvbi1ib3RAb3Blbm1ldGFkYXRhLm9yZyIsImlzQm90Ijp0cnVlLCJ0b2tlblR5cGUiOiJCT1QiLCJpYXQiOjE3MDEyNTk4MzMsImV4cCI6bnVsbH0.Y3AtFR-AsURq3n88kvDEfWC3JNOsPcf68A8hX01Bhwiy1M1xMU7Mbj_hQse9T2IlFewzwxNLJy_HLVZ3Tdp-DDzkflkVdYUodq0Th6KwfkkQqXLRE0_ALsSj4uaODc_0XBMDf-_B_KKZKai83eqU9hO9Ttyq32dj774ICAxGY50FJKR0mPdqjAFZJNIIAiMSD7vaZ6eGiNCbMcjijfxnykUhUIKE2BsWJNwFXZv_GWdrzucPEijzilDpAHRMNRaGEhU47tn0GWXdYFOXbM3puHqmn1IKHNlTf7l4V1847K_THnsdNaj1xVdgsNR-CSRr-gWgbYlgEhy8Jf0l3gx83Q'
om_host = 'data.kenyahmis.org:8082'
...
for table_name in tables:
    ...
    try:
        response = requests.get(table_glossary_uri, headers={"Authorization": "Bearer " + jwt_token})
        ...
        if response.status_code // 100 == 2:
            ...
            if table_description:
                ...
                for column_name in columns:
                    ...
                    try:
                        response = requests.get(column_glossary_uri, headers={"Authorization": "Bearer " + jwt_token})
                        response.raise_for_status()
                        ...
                        if response.status_code // 100 == 2:
                          ...
                          if he.response.status_code // 100 == 4:
                            ...
                            print(
                                f"Failed to retrieve column description for {column_name} with message {he.response.text}", he)
...
async def query_from_natural_language(nl_query: NaturalLanguageQuery):
    try:
        ...
        response = nl_sql_retriever.retrieve_with_metadata(custom_txt2sql_prompt + nl_query.question)
